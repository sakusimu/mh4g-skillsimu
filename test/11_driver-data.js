...
QUnit.test('equips', function () {
    ...
    QUnit.equal(got, 348, 'equips.head.length');
    ...
    QUnit.equal(got, 343, 'equips.body.length');
    ...
    QUnit.equal(got, 338, 'equips.arm.length');
    ...
    QUnit.equal(got, 333, 'equips.waist.length');
    ...
    QUnit.equal(got, 339, 'equips.leg.length');
