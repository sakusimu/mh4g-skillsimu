...
QUnit.test('equips', function () {
    ...
    QUnit.equal(got, 350, 'equips.head.length');
    ...
    QUnit.equal(got, 345, 'equips.body.length');
    ...
    QUnit.equal(got, 335, 'equips.waist.length');
    ...
    QUnit.equal(got, 341, 'equips.leg.length');
