...
QUnit.test('normalize: selected equips', function () {
    ...
    exp = { head: 34, body: 2, arm: 28, waist: 28, leg: 32, weapon: 1 };
    ...
    got = n.normalize([ '攻撃力UP【大】', '業物' ]);
    exp = { head: 34, body: 5, arm: 28, waist: 28, leg: 32, weapon: 1 };
...
QUnit.test('normalize: summary', function () {
    ...
    got = n.normalize([ '攻撃力UP【大】', '業物' ]);
    exp = { head: 34, body: 28, arm: 28, waist: 28, leg: 32, weapon: 1 };
    QUnit.deepEqual(summary(got), exp, "[ '攻撃力UP【大】', '業物' ]");

    got = n.normalize([ '斬れ味レベル+1', '高級耳栓' ]);
    exp = { head: 20, body: 16, arm: 19, waist: 21, leg: 23, weapon: 1 };
    ...
    exp = { head: 383, body: 212, arm: 244, waist: 300, leg: 250, weapon: 1 };
