...
DecoCombinator.prototype._makeCombSetList = function (combsSet) {
...
DecoCombinator.prototype._makeCombsSet = function (skillTrees, equips) {
...
DecoCombinator.prototype._calcPoint = function (combSet) {
    var skillCombs = [];
...
DecoCombinator.prototype._isBeyond = function (goal, skillComb) {
