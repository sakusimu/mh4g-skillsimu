(function (define) {
'use strict';
var deps = [ '../equip.js', '../data.js',
             '../util.js', '../util/skill.js', '../util/deco.js' ];
define(deps, function (Equip, data, Util, Skill, Deco) {
   ...
   typeof module !== 'undefined' && module.exports ?
       ...
       function (deps, factory) {
           factory(this.simu.Equip, this.simu.data,
                   this.simu.Util, this.simu.Util.Skill, this.simu.Util.Deco);
       }
);
