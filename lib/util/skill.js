...
/**
 * skillComb のコピーを作成して返す。
 */
Skill.clone = function (skillComb) {
    var ret = {};
    if (skillComb == null) return null;
    for (var tree in skillComb) ret[tree] = skillComb[tree];
    return ret;
};
...
Skill.merge = function () {
    ...
    var combs = Util.isArray(args[0]) ? args[0] : args;
    var ret = {};
